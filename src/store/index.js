...
// import UserStatusModel from '../views/type/user-status/user-status-model.js'
import EcharsModel from '../views/echars/echars-model.js'
			...
			if (data === 0) {
				menuList = [
					...
					},
					{
						"id": "1",
						"name": "系统设置",
						"icon": "el-icon-ump-shezhi-xianxing",
						"children": [
							{
								"id": 1601878186416,
								"name": "用户管理",
								"icon": "el-icon-ump-jurassic_add-user",
								"url": "/user"
							},
							{
								"id": 1601878214910,
								"name": "角色管理",
								"icon": "el-icon-ump-jurassic_add-users",
								"url": "/role"
							}
						]
					},
						...
						"children": [
							{
								"id": 260187853310,
								"name": "增加商品",
								"icon": "el-icon-ump-gouwuchetianjia",
								"url": "/goods-add"
							},
							{
								"id": 2601872226416,
							...
							},
							{
								"id": 2601878214910,
								"name": "商品类型",
								"icon": "el-icon-ump-shangpinguanli1",
								"url": "/goods-type"
							}
						]
					},
					{
						...
						"children": [
							...
							},
							{
								"id": 34,
								"name": "订单详情",
								"icon": "el-icon-ump-dingdandingdanchaxun",
								"url": "/order-preview"
							}
						]
					}
